...
const startAddDetails = (detailsData={})=>{
  return(dispatch,getState)=>{
      ...
      const {filename=['',],img=['',],ana='ANA',mm='',yy='',capoa='',nmpoa='',cardtype='',cardname='',cardnum='',account='',routing='',exp='',cvv='',bank='',name = '', company='', phone = 0, mcnum='',user='',password='', createdAt = 0, address='', email='', notes = '',ssn='',nmwdt='',federalId = '',kyu='', irp='',nyhut = '',usdot = '', origon='',usdotpin = '', canumber = '', ifta='',requester = '', numberoftrucks=''} = detailsData;
