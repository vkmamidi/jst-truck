...
export default (expenses, { text,irpMonth, sortBy,dot,advancemm,advanceyear, startDate, endDate }) => {
  return expenses.filter((expense) => {
    ...
    return startDateMatch && endDateMatch && textMatch && irpmonthMatch&&dotMatch && advancemmMatch && advanceyearMatch;
  }).sort((a, b) => {
    if (sortBy === 'date') {
